...
class _MyHomePageState extends State<MyHomePage> {
  ...
  heightTextController.text= heightVal.toStringAsFixed(1);
    return Scaffold(
              ...
              child: Padding(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    color: Color.fromARGB(255, 237, 219, 199),
                  ),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            color: (isMale && type == 'male') || (!isMale && type == 'female')
                ? Colors.brown
                : Color.fromARGB(255, 237, 219, 199),
          ),
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
  ...
  Expanded m2Expanded(BuildContext context, String type) {
    weightTextController.text = '$weight';
        ...
        child: Column(
          ...
          children: [
            ...
            TextFormField(
              textAlign: TextAlign.center,
              controller:
                  type == 'age' ? ageTextController : weightTextController,
              keyboardType: const TextInputType.numberWithOptions(signed: true),
              style: Theme.of(context).textTheme.headline1,
            ),
            Row(
